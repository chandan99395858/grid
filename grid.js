...
for (var i = 0; i < productList.length; i++) {
    ...
    if (productList[i].isAccessory === false) {
        ...
        var clothCard = document.createElement("a");
        clothCard.className = "cloth-card";
        clothCard.href = "#"

        var clothImg = document.createElement("img");
        clothImg.className = "cloth-img";
        clothImg.src = productList[i].preview;
        ...
        cardContent.appendChild(heading3);
        cardContent.appendChild(heading4);
        cardContent.appendChild(heading5);

        clothCard.appendChild(clothImg);
        clothCard.appendChild(cardContent);

        newCard.appendChild(clothCard);
...
for (var i = 0; i < productList.length; i++) {
    ...
    if (productList[i].isAccessory === true) {
        ...
        var cardContainer1 = document.getElementById("card-container1");
